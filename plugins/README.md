...
| [ryan-trahan-style](./ryan-trahan-style/) | Generate YouTube scripts, hooks, outlines, and video concepts in the exact style of Ryan Trahan — including his 6-step hook formula, three-act challenge vlog structure, and self-deprecating voice | **Skill:** `ryan-trahan-style` - Auto-invoked when user asks to write content "in the style of Ryan Trahan" |
